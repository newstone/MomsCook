...
QT_MOC_LITERAL(1, 9, 16), // "clickTextBrowser"
...
QT_MOC_LITERAL(7, 63, 19), // "openAddContentsView"
QT_MOC_LITERAL(8, 83, 18) // "openStatisticsView"

    },
    "MomsCook\0clickTextBrowser\0\0QTextBrowser*\0"
    "obj\0handleButton\0flag\0openAddContentsView\0"
    "openStatisticsView"
};
...
void MomsCook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->openAddContentsView(); break;
        case 3: _t->openStatisticsView(); break;
        default: ;
        }
        ...
        {
            using _t = void (MomsCook::*)(QTextBrowser * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MomsCook::clickTextBrowser)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MomsCook::clickTextBrowser(QTextBrowser * _t1)
{
